...
export const OMB_S6 = cite('OMB: FY2025 Budget, Table S-6 (mandatory and receipt proposals)', 'https://bidenwhitehouse.archives.gov/wp-content/uploads/2024/03/budget_fy2025.pdf', '2024-03-11')
...
export const DEM_PLATFORM = cite('2024 Democratic Party Platform', 'https://democrats.org/wp-content/uploads/2025/07/2024-Democratic-Party-Platform.pdf', '2024-08-19')
export const CRFB_HARRIS = cite('CRFB: Fiscal impact of the Harris and Trump campaign plans', 'https://www.crfb.org/papers/fiscal-impact-harris-and-trump-campaign-plans', '2024-10-28')
...
export const COLLEGE_FOR_ALL = cite('College for All Act of 2025, S.1832: bill text', 'https://www.govinfo.gov/content/pkg/BILLS-119s1832is/html/BILLS-119s1832is.htm', '2025')
export const SSEA_OACT = cite('SSA Chief Actuary: Social Security Expansion Act: solvent through 2096', 'https://www.sanders.senate.gov/wp-content/uploads/SandersLetter-2023-0213.pdf', '2023-02-13')
...
export const LP = cite('Libertarian Party Platform', 'https://www.lp.org/platform/', '2026-05-25')
export const HAWLEY_RURAL = cite('Hawley: Protect Medicaid and Rural Hospitals Act (double Rural Health fund to $100B)', 'https://www.hawley.senate.gov/hawley-introduces-legislation-to-prevent-future-medicaid-cuts-invest-in-rural-hospitals/', '2025-07-15')
...
export const BUTTIGIEG_HEALTH = cite('CRFB: Estimating Democratic candidates’ health plans (2020)', 'https://www.crfb.org/papers/primary-care-estimating-democratic-candidates-health-plans', '2020')
...
export const BUTTIGIEG_EDU = cite('Buttigieg 2020: education plan (archived)', 'https://web.archive.org/web/20200201193954/https://peteforamerica.com/policies/education/', '2020')
export const BOOKER_BONDS = cite('Booker: Baby Bonds (American Opportunity Accounts Act), design only; no cost estimate exists', 'https://www.booker.senate.gov/news/press/booker-pressley-reintroduce-bicameral-baby-bonds-legislation-to-tackle-wealth-inequality', '2023')
...
export const GALLEGO_HOUSING = cite('Gallego: “The Path Home” housing framework (no total, no score)', 'https://www.gallego.senate.gov/wp-content/uploads/2026/01/Housing-Plan.pdf', '2026-01-14')
